...
function Franklin() {
    ...
    imagemDoPersonagem.src = 'imagem-franklin.jpg';
    ...
    fundoDoCartao.style.backgroundImage = `url('fundo-franklin.jpg')`;
}

function Luis() {
    nomeDoPersonagem.textContent = 'Luis Fernando';
    imagemDoPersonagem.src = 'imagem-luis.jpg';
    ...
    fundoDoCartao.style.backgroundImage = `url('fundo-luis.jpg')`;
}

function Michael() {
    nomeDoPersonagem.textContent = 'Michael de Santa';
    imagemDoPersonagem.src = 'imagem-michael.jpg';
    ...
    fundoDoCartao.style.backgroundImage = `url('fundo-michael.jpg')`;
}

function Niko() {
    nomeDoPersonagem.textContent = 'Niko Bellic';
    imagemDoPersonagem.src = 'imagem-niko.jpg';
    ...
    fundoDoCartao.style.backgroundImage = `url('fundo-niko.jpg')`;
}   

function Tommy() {
    nomeDoPersonagem.textContent = 'Tommy Vercetti';
    imagemDoPersonagem.src = 'imagem-tommy.jpg';
    ...
    fundoDoCartao.style.backgroundImage = `url('fundo-tommy.jpg')`;
}

function Trevor() {
    nomeDoPersonagem.textContent = 'Trevor Philips';
    imagemDoPersonagem.src = 'imagem-trevor.jpg';
    ...
    fundoDoCartao.style.backgroundImage = `url('fundo-trevor.jpg')`;
}
